...
**Stack:** Python 3.12 | FastAPI 0.115.x | PostgreSQL 16 | Railway PaaS
...
│   │   └── deploy.yml       # Auto-deploy Railway
...
│   └── DEPLOYMENT.md        # Guía despliegue Railway
│
├── docker/
  ...
  deploy:
    ...
    steps:
      - name: Deploy to Railway
        ...
        run: |
          curl -L https://railway.app/cli/releases/latest/download/railway-linux-x64 -o railway
          chmod +x railway
          ./railway up \
...
APP_ENV = "production"
LOG_LEVEL = "INFO"
# DATABASE_URL, GITHUB_API_TOKEN, JWT_SECRET_KEY vía Railway Secrets
```
...
| **Sprint 6** | 02-Nov a 08-Nov | Despliegue + Docs | Deploy a Railway, documentación final |
