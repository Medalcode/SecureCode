...
CLOUD:          Railway PaaS | Docker 27.x
...
- AES-256 en reposo (backups Railway)
- Secrets en Railway Vault
...
- Healthcheck cada 60 segundos monitoreado por Railway
...
- [ ] API deployment testeado (Railway o local)
